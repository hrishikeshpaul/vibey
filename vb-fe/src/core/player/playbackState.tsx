...
export function usePlaybackState(interval: true, durationMS?: number): Spotify.PlaybackState | null;
export function usePlaybackState(interval?: boolean, durationMS = 1000): Spotify.PlaybackState | null {
