...
import { useEffectTimeout } from "core/player/useEffectTimeout";
import { useWebPlaybackSDKReady } from "core/player/WebPlaybackSDKReady";
...
export type SpotifyPlayer = Omit<Spotify.Player, "addListener" | "on" | "removeListener" | "setName" | "_options">;
...
export function useSpotifyPlayer(): SpotifyPlayer | null {
  ...
  const player = useMemo<SpotifyPlayer | null>(() => {
    ...
    return {
      ...
      setVolume: (volume) => value.setVolume(volume),
      getVolume: () => value.getVolume(),
    };
  }, [value]);
