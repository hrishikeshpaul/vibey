  ...
  return (
    <div className="text-white px-2 pb-3 rounded-lg shadow-sm">
      <div className="d-flex align-items-center">
        <div>
          <div className="d-flex align-items-center pt-3">
            <Icon Component={HiUser} size={[1.5, 1.5]} />
          ...
          <div className="d-flex align-items-center pt-3">
            <Icon Component={HiMail} size={[1.5, 1.5]} />
            <p className="m-0 pl-2">
              <b>{userData.email}</b>
            </p>
          </div>
          ...
          <div className="d-flex align-items-center pt-3">
            <Icon Component={Thumb} size={[1.2, 1.2]} color="#4aaeae" />
      ...
      <div className="d-flex w-100 justify-content-center mt-4 pt-3">
        <button className="btn bg-warning text-white font-weight-bold" onClick={handleLogout} type="button">
          Logout
        </button>
      </div>
    </div>
