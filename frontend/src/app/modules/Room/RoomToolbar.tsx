  ...
  return (
    <div className="d-flex justify-content-between align-items-center text-white">
      <div className="d-flex align-items-center">
        <IconButton aria-label="Search database" className="bg-transparent icon-btn" size="md" icon={<Icon Component={Back} size={[1.5,1.5]}></Icon>} />
        <IconButton aria-label="Search database" className="bg-transparent icon-btn ml-2" size="md" icon={<Icon Component={Edit} size={[1,1]}></Icon>} />
        <IconButton aria-label="Search database" className="bg-transparent icon-btn ml-2" size="md" icon={<Icon Component={Share} size={[1,1]}></Icon>} />
      </div>
